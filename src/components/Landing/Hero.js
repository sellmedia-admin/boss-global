  ...
  return (
    <div className='bg-heroBg bg-cover bg-center bg-no-repeat relative h-full lg:h-screen md:h-screen hero_section mb-36'>
      <div className='h-full w-full flex flex-col justify-between'>
        <Navigation />
        <div className='text-white text-center w-full max-w-760 mx-auto px-4 py-10' data-aos="fade-up" data-aos-duration="500">
        ...
        <div className='max-w-default mx-auto w-full px-4 -mb-10' data-aos="fade-up" data-aos-duration="700">
